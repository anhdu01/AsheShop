			...
			<div class="col-md-12 main">
				...
				<div class="pagi">
					<div class="col-md-1" style="left:-350px;">
						<p>
							<a href="<%=request.getContextPath()%>/admin/addPolicy?type=load" class="btn btn-success create-button"><i class="fa fa-plus" style="font-size:12px"></i> Thêm mới</a>
		        		</p>
		    		</div>
					<ul class="pagination">
					<%
					...
					%>
  						<li <%=active %>><a href="<%=request.getContextPath() %>/admin/indexPolicy?page=<%=i%>"><%=i %></a></li>
  					<%} %>
					</ul>
				</div>	
			</div>
